...
```javascript
import someByRight from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-by-right@v0.2.3-esm/index.mjs';
```
...
import randu from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-randu@esm/index.mjs';
import someByRight from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-by-right@esm/index.mjs';
